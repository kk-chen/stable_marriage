...
def getData():
    ...
    # initialization: there exists a line in the file
    # maintenance: there exists another line in the file
    # termination: terminate if there are no more lines in the file
    for line in infile:
        line = line.strip()
        line = line.split(' ')
...
def match():
    ...
    while(len(men) > 0):
        ...
        del menPrefs[man][1]
    # print the pairs
    # initialization: p exists in pairs
    # maintenance: there's another p that exists in pairs
    # termination: there is no more p in pairs
    for p in pairs:
